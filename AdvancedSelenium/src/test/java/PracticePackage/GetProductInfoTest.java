...
public Object[][] getData() throws EncryptedDocumentException, IOException
{
	...
	int rowCont = e.getRowcount("Test");
	Object[][] objArr=new Object[rowCont][2];
	
	for(int i=0;i<rowCont;i++)
	{
		String data1 = e.getDataFromExcelFile("Test", i+1, 0);
		String data2 = e.getDataFromExcelFile("Test", i+1, 1);
...
public void setData() throws EncryptedDocumentException, IOException
{
	...
	//driver.findElement(By.id("nav-search-submit-button")).click();
     List<WebElement> price = driver.findElements(By.xpath("//span[contains(text(),'Apple iPhone 15 ')]"));
     ExcelUtility f=new ExcelUtility();
     int i=0;
	for(WebElement p:price )
	{
		String cellValue=p.getText();
		f.SeDataIntoExcel("Test", i, 1, cellValue);
		i++;
